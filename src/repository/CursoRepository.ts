...
export const cursos: CursoEntity[] = [
  ...
  new CursoEntity(5, "Nutrição"),
  new CursoEntity(6, "Pedagogia"),
  new CursoEntity(7, "Odontologia"),
  new CursoEntity(8, "Psicologia"),
  new CursoEntity(9, "Farmácia"),
  new CursoEntity(10, "Direito"),
]