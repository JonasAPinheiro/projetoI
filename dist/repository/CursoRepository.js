...
exports.cursos = [
    ...
    new CursoEntity_1.CursoEntity(5, "Nutrição"),
    new CursoEntity_1.CursoEntity(6, "Pedagogia"),
    new CursoEntity_1.CursoEntity(7, "Odontologia"),
    new CursoEntity_1.CursoEntity(8, "Psicologia"),
    new CursoEntity_1.CursoEntity(9, "Farmácia"),
    new CursoEntity_1.CursoEntity(10, "Direito"),
];
